<template>
    <div style="backgroundImage: url('/zhihuishenghuoshangcheng/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">智慧生活商城系统注册</h1>
