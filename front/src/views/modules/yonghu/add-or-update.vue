    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现积分" prop="yonghuNewJifen">
                       <el-input v-model="ruleForm.yonghuNewJifen"
                                 placeholder="现积分" clearable  :readonly="ro.yonghuNewJifen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现积分" prop="yonghuNewJifen">
                           <el-input v-model="ruleForm.yonghuNewJifen"
                                     placeholder="现积分" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuNewJifen: [
                              { required: true, message: '现积分不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
