...
import center from '@/views/center'
    ...
    import dictionaryShangpinTuihuo from '@/views/modules/dictionaryShangpinTuihuo/list'
    import dictionaryShangpinTuihuoYesno from '@/views/modules/dictionaryShangpinTuihuoYesno/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryShangpinTuihuo',
        name: '退货状态',
        component: dictionaryShangpinTuihuo
    }
    ,{
        path: '/dictionaryShangpinTuihuoYesno',
        name: '审核状态',
        component: dictionaryShangpinTuihuoYesno
    }
    ,{
